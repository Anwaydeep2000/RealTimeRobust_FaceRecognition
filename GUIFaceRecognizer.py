...
def train_classifier():
    data_dir="C:/Users/Mayukh_Chatterjee/Desktop/finalYear/datagui"
    ...
    if(t1.get()=="" or t2.get()=="" or t3.get()==""):
        ...
        while True:
            ...
            if face_cropped(frame) is not None:
                ...
                file_name_path = "datagui/user."+str(id)+"."+str(img_id)+".jpg"
